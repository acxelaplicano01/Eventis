...
<body class="dark:bg-gray-900">
    ...
    <div class="container max">
        ...
        @endif
        <div class="forms">
            <div class="form mb-12 login active bg-white rounded-md dark:bg-gray-800">
                <div class="flex content-center mt-8 mx-20 items-center">
                    <x-application-mark />
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="checkbox-text">
                        <div class="checkbox-content">
                            <input class="text-yellow-600 border-yellow-400" type="checkbox" id="remember_me"
                                name="remember">
                ...
                <div class="login-signup">
                    <span class="text text-black dark:text-white">¿No tienes cuenta?
                        <a href="{{ route('register') }}"
                            class="text text-yellow-800 dark:text-yellow-600 signup-link">Registrarse</a>
                    </span>
                </div>
            </div>
        </div>
