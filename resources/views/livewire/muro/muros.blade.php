    ...
    <main role="main">
        <div class="flex">
            <section class="dark:bg-gray-900 w-[1130px]">
                                    ...
                                    <div class="lg:col-span-3 xl:col-span-3">
                                        <div
                                            ...
                                            <div>
                                                <div class="py-4">
                                                    <h3
                                                        class="flex text-xs font-medium dark:text-gray-400 text-gray-500">
                                                    ...
                                                    <p class="mt-1 text-4xl font-bold dark:text-white text-gray-700">
                                                        {{$publicacionesCount}}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="px-1 py-4">
                                                    ...
                                                    <p class="mt-1 text-4xl font-bold dark:text-white text-gray-700">14
                                                    </p>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="px-1 py-4">
                                                    ...
                                                    <p class="mt-1 text-4xl font-bold dark:text-white text-gray-700">2
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div x-data="{ activeTab: localStorage.getItem('activeTab') || 'styled-profile', activeModal: null }"
                    ...
                    <!-- Tabs -->
                    <div class="border-t bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" role="tablist">
                            <li class="me-2" role="presentation">
                                <button @click="activeTab = 'styled-profile'" :class="activeTab === 'styled-profile' ? 'text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-500 border-yellow-500 dark:border-yellow-500' : 'dark:border-transparent border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300'"
                                    class="inline-block p-4 border-b-2 rounded-t-lg">Publicaciones</button>
                            </li>
                            <li class="me-2" role="presentation">
                                <button @click="activeTab = 'styled-settings'" :class="activeTab === 'styled-settings' ? 'text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-500 border-yellow-500 dark:border-yellow-500' : 'dark:border-transparent border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300'"
                                    class="inline-block p-4 border-b-2 rounded-t-lg">Información</button>
                            </li>
                            <li class="me-2" role="presentation">
                            ...
                            <li role="presentation">
                                <button @click="activeTab = 'styled-contacts'" :class="activeTab === 'styled-contacts' ? 'text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-500 border-yellow-500 dark:border-yellow-500' : 'dark:border-transparent border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300'"
                                    class="inline-block p-4 border-b-2 rounded-t-lg">Contacts</button>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div x-show="activeTab === 'styled-profile'" class="rounded-lg bg-gray-100 dark:bg-gray-900">
                            <div class="flex" style="width: 1130px;">
                                <aside class="w-2/5 h-12 -top-[660px] sticky">
                                    ...
                                    <div style="max-width:380px;">
                                        <div class="overflow-y-auto">
                                            ...
                                            <!--detalles user-->
                                            <div
                                                class="max-w-sm mr-4 mt-1 p-2 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-4 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="dark:bg-gray-900 w-4/5" style="max-width:600px;">
                                    @if(auth()->user()->id === $userperfil->id)
                                        <div class="mt-1 mb-4 shadow-sm rounded-lg dark:bg-gray-800">
                                            <div
                                        ...
                                        <div class="mt-4 mb-4 shadow-sm rounded-lg dark:bg-gray-800">
                                            <div
                                                ...
                                                <article>
                                                    <div class="flex items-center mb-4">
                                                        ...
                                                        <div class="dark:text-white">
                                                            ...
                                                            @if(auth()->user()->id !== $userperfil->id)
                                                                ...
                                                                @endif
                                                            @endif
                                                            <button id="{{$publicacion->id}}"
                                                                data-dropdown-toggle="{{$publicacion->id}}"
                                                    ...
                                                    <div id="imagenModal{{ $publicacion->id }}" tabindex="-1"
                                                        aria-hidden="true"
                                ...
                                <aside class="w-2/5 h-12 -top-[460px] sticky">
                                    ...
                                    <div style="max-width:380px;">
                                        <div class="overflow-y-auto">
                                            ...
                                            <div
                                                class="max-w-sm rounded-lg bg-white dark:bg-gray-800 p-3 dark:bg-dim-700 bg-dim-700 overflow-hidden shadow-sm my-1 ml-4">
        ...
        $diaSemanaEsp = $diasSemana[$diaSemana];
            ...
            : route('reporteEvento', ['evento' => $evento->id]) }}"
                        ...
                        <div x-show="activeTab === 'styled-contacts'"
