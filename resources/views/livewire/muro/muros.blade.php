                        ...
                        <div data-popover id="popover-user-publicacion-{{ $userperfil->id }}" role="tooltip"
                                ...
                                <div class="p-3">
                                        ...
                                        @if ($userperfil->profile_photo_path)
                                            <a href="#">
                                                <img data-popover-target="popover-user-publicacion-{{ $userperfil->id }}"
                                                    class="w-10 h-10 me-2 object-cover rounded-full" src="/storage/{{$userperfil->profile_photo_path }}" alt="">
                                            </a>
                                    ...
                                    <p class="mb-4 text-sm">{{ $userperfil->descripcion}} <a href="#"
                                            class="text-blue-600 dark:text-blue-500 hover:underline">{{ $userperfil->pagina}}</a>.</p>
                                    <ul class="flex text-sm">
                                        <li class="me-2">
                                            <a href="#" class="hover:underline">
                                                <span class="font-semibold text-gray-900 dark:text-white">{{$seguidores->count()}}</span>
                                                <span>Seguiendo</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="hover:underline">
                                            <span class="font-semibold text-gray-900 dark:text-white">{{$seguidos->count()}}</span>
                                    ...
                                    <div class="bg-white px-4 pt-4 border rounded-lg dark:bg-gray-800 dark:border-gray-600">
                                        <article>
                                            <div class="flex items-center mb-4">
                                                @if ($userperfil->profile_photo_path)
                                                    <img data-popover-target="popover-user-publicacion-{{ $userperfil->id }}" class="w-10 h-10 me-2 object-cover rounded-full"
                                                        src="/storage/{{$userperfil->profile_photo_path }}" alt="">
                                                @else 
                                                    <img data-popover-target="popover-user-publicacion-{{ $userperfil->id }}" class="w-10 h-10 me-2 object-cover rounded-full"
                                                        src="https://ui-avatars.com/api/?name={{ $userperfil->name }}&amp;color=000&amp;background=facc15">
                                                ...
                                                <div class="dark:text-white">
                                                    ...
                                                    @if(auth()->user()->id !== $userperfil->id)
                                                        ...
                                                        @else
                                                            <button wire:click="seguir({{ $userperfil->id }})" class="text-yellow-500 font-semibold">
                                            ...
                                            <div class="flex items-center dark:border-gray-600 border-gray-200 border-t py-2">
                                                ...
                                                <div data-modal-target="imagenModal{{ $publicacion->id }}"
                                                    ...
                                                    <span class="font-medium ml-2 text-gray-600 dark:text-white">Escribe un
                                                        comentario...</span>
                                                </div>
                                            </div>
                                            @endif
