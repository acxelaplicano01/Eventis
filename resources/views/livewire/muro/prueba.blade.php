...
<div x-data="{ activeTab: localStorage.getItem('activeTab') || 'styled-profile', activeModal: null }"
    ...
    <!-- Tabs -->
    <div class="mb-1 border-t bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" role="tablist">
            <li class="me-2" role="presentation">
                <button @click="activeTab = 'styled-profile'" :class="activeTab === 'styled-profile' ? 'text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-500 border-yellow-500 dark:border-yellow-500' : 'dark:border-transparent border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300'" class="inline-block p-4 border-b-2 rounded-t-lg">Publicaciones</button>
            </li>
            <li class="me-2" role="presentation">
                <button @click="activeTab = 'styled-settings'" :class="activeTab === 'styled-settings' ? 'text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-500 border-yellow-500 dark:border-yellow-500' : 'dark:border-transparent border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300'" class="inline-block p-4 border-b-2 rounded-t-lg">Información</button>
            </li>
            <li class="me-2" role="presentation">
                <button @click="activeTab = 'styled-dashboard'" :class="activeTab === 'styled-dashboard' ? 'text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-500 border-yellow-500 dark:border-yellow-500' : 'dark:border-transparent border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300'"
                    class="inline-block p-4 border-b-2 rounded-t-lg">Eventos</button>
            </li>
            <li role="presentation">
                <button @click="activeTab = 'styled-contacts'" :class="activeTab === 'styled-contacts' ? 'text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-500 border-yellow-500 dark:border-yellow-500' : 'dark:border-transparent border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300'" class="inline-block p-4 border-b-2 rounded-t-lg">Contacts</button>
            </li>
        </ul>
    </div>
    ...
    <div class="mt-4">
        <div x-show="activeTab === 'styled-profile'" class="rounded-lg bg-gray-100 dark:bg-gray-900">
                ...
                <aside class="w-2/5 h-12 -top-[660px] sticky">
                    ...
                    <div style="max-width:380px;">
                        <div class="overflow-y-auto">
                            ...
                            <!--detalles user-->
                            <div
                                class="max-w-sm mr-4 mt-4 p-2 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-4 dark:bg-gray-800 dark:border-gray-700">
                                <div class="flex justify-between">
                                    <h5 class="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">
                                        Detalles</h5>
                                    <!-- Editar Button -->
                                    @if(auth()->user()->id === $userperfil->id)
                                        <svg @click="activeModal = 'modal1'"
                                            class="w-6 h-6 cursor-pointer dark:hover:text-yellow-500 hover:text-yellow-500 text-gray-800 dark:text-gray-400"
                                ...
                                <ul role="list" class="space-y-3 my-1">
                                    <li
                                        class="flex text-base font-bold leading-tight text-gray-800 dark:text-gray-200 items-center">
                                        ...
                                        Se unió
                                        <span
                                            class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">{{ $userperfil->created_at->diffForHumans() }}</span>
                                    </li>
                                    <li
                                        class="flex text-base font-bold leading-tight text-gray-800 dark:text-gray-200 items-center">
                                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                        ...
                                        País
                                        <span
                                            class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Honduras</span>
                                    </li>
                                    <li
                                        class="flex text-base font-bold leading-tight text-gray-800 dark:text-gray-200 items-center">
                                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                        ...
                                        Ciudad
                                        <span
                                            class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Choluteca</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="flow-root m-6">
                                <div class="flex-1">
                                    <a href="#">
                                        <p class="text-sm leading-6 font-medium text-gray-500">Terms
                                            Privacy
                ...
                <div class="dark:bg-gray-900 w-4/5" style="max-width:600px;">
                    @if(auth()->user()->id === $userperfil->id)
                        <div class="mt-4 mb-4 shadow-sm rounded-lg dark:bg-gray-800">
                            <div class="bg-white pt-4 px-4 border rounded-lg dark:bg-gray-800 dark:border-gray-600">
                                <article>
                                    ...
                                    <div class="dark:border-gray-600 border-gray-200 border-t flex items-center py-3 px-6">
                                        <div wire:click="create"
                                            ...
                                            <svg class="w-7 h-7 ml-7 text-green-600 dark:text-green-600" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                fill="currentColor" viewBox="0 0 24 24">
                                                <path fill-rule="evenodd"
                                        ...
                                        <div wire:click="create"
                                            ...
                                            <svg class="w-7 h-7 ml-7 text-blue-500 dark:text-blue-500" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                                viewBox="0 0 24 24">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="2"
                    ...
                    @foreach($publicaciones as $publicacion)
                        <div class="mt-4 mb-4 shadow-sm rounded-lg dark:bg-gray-800">
                            <div class="bg-white px-4 pt-4 border rounded-lg dark:bg-gray-800 dark:border-gray-600">
                                <article>
                                        ...
                                        <div class="dark:text-white">
                                            ...
                                            @if(auth()->user()->id !== $userperfil->id)
                                                @if(auth()->user()->siguiendo->contains($userperfil->id))
                                                    <button wire:click="dejarDeSeguir({{ $userperfil->id }})"
                                                        ...
                                                        <span class="text-gray-800 dark:text-gray-200 mr-1">·</span>Siguiendo
                                                    </button>
                                                @else
                                                    <button wire:click="seguir({{ $userperfil->id }})"
                                                        class="text-yellow-500 font-semibold">
                                                        <span class="text-gray-800 dark:text-gray-200 mr-1">·</span>Seguir
                                                    </button>
                                                @endif
                                            @endif
                                            <button id="{{$publicacion->id}}" data-dropdown-toggle="{{$publicacion->id}}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="bg-white rounded-lg text-left overflow-hidden shadow-sm transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full dark:bg-gray-800"
                                                        ...
                                                        <div class="p-6">
                                                            ...
                                                            <p class="dark:text-gray-300">{{ session('error') }}
                                                            </p>
                                            ...
                                            @elseif ($confirmingDelete)
                                                <div
                                                    class="fixed z-50 inset-0 flex items-center justify-center overflow-y-auto ease-out duration-400">
                                                    <div class="fixed inset-0 transition-opacity">
                                                        <div class="absolute inset-0 bg-gray-800 opacity-60">
                                                        </div>
                                                    </div>
                                    ...
                                    <p class="pl-1 mt-4 mb-2 text-base width-auto font-medium dark:text-white flex-shrink">
                                    ...
                                    @if ($publicacion->foto)
                                        <div class="flex items-center dark:border-gray-600 border-gray-200 border-t py-2">
                                            @if ($userperfil->profile_photo_path)
                    ...
                    <div style="max-width:380px;">
                        <div class="overflow-y-auto">
                            ...
                            <div
                                ...
                                <div class="relative text-gray-400 w-full mb-3">
                                    ...
                                    <input name="buscar" wire:model.live="search" type="text" id="table-search-users"
                                        placeholder="Buscar eventos..." class="h-10 px-10 pr-5 w-full text-sm text-gray-700 dark:text-gray-200 
                                    ...
                                    @foreach($Eventos as $evento) 
                                            ...
                                            <a href="{{ route('reporteEvento', ['evento' => $evento->id]) }}"
                                                ...
                                                <img class="rounded-t-lg w-full h-24 object-cover"
                                                    src="{{ asset('storage/' . $evento->logo) }}" alt="Logo del Evento" />
                                            </a>
                            ...
                            <div
                                ...
                                <div class="relative text-gray-400 w-full mb-3">
                                    ...
                                    <input name="buscar" wire:model.live="search" type="text" id="table-search-users"
                                        placeholder="Buscar amigos..." class="h-10 px-10 pr-5 w-full text-sm text-gray-700 dark:text-gray-200 
                                        bg-gray-100 dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400 
                                        focus:outline-none focus:ring-2 focus:ring-yellow-500 
                                        rounded-lg border border-gray-300 dark:border-gray-600 shadow-sm">
                                </div>
        ...
        <div x-show="activeTab === 'styled-settings'">
            <p class="text-sm text-gray-500 dark:text-gray-400">Contenido de Información</p>
        </div>
        <div x-show="activeTab === 'styled-dashboard'">
            <div class="pt-2">
                <div class="content-wrapper">
                    @if($Eventos->isEmpty())
                        <div class="p-4 my-2 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-500 dark:border-yellow-800"
                            role="alert">
                            <div class="flex items-center">
                                                                                    ...
                                                                                    <div class="border-t border-gray-200 dark:border-gray-700">
                                                                                        <div class="flex">
                                                                                            <div class="flex items-center flex-1 pl-6 pr-1 py-5 w-16">
                                                                                                ...
                                                                                                <div data-popover id="popover-company-profile-{{$evento->id}}"
                                                                                                    role="tooltip"
                                                                                            ...
                                                                                            <a href="{{ route('reporteEvento', ['evento' => $evento->id]) }}"
                                                                                                ...
                                                                                                Evento
                                                                                                <svg class="w-5 h-5 ml-2" xmlns="http://www.w3.org/2000/svg"
        ...
        <div x-show="activeTab === 'styled-contacts'" class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
            <p class="text-sm text-gray-500 dark:text-gray-400">Contenido de Contacts</p>
        </div>
    </div>

    <!-- Modales -->
    <template x-if="activeModal === 'modal1'">
