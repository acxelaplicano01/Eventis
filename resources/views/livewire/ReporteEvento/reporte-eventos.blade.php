                                                        ...
                                                        <div class="border-t border-gray-200 dark:border-gray-700">
                                                            <div class="flex">
                                                                <div class="flex items-center flex-1 px-6 py-5">
                                                                    <img class="object-cover w-8 h-8 rounded-full" data-popover-target="popover-company-profile-{{$evento->id}}" 
                                                                                ...
                                                                                <div class="flex">
                                                                                    <div class="me-3 shrink-0">
                                                                                        <a href="#" class="block p-2 bg-gray-100 rounded-lg dark:bg-gray-700">
                                                                                            <img class="w-8 h-8 rounded-full" src="https://cdn.rareblocks.xyz/collection/celebration/images/blog/3/avatar-3.jpg"
                                                                                                alt="Flowbite logo">
                                                                                        </a>
                                                                                    </div>
                                                                                    <div>
