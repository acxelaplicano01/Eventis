        ...
        <div class="row dark:bg-gray-800 dark:text-white text bg-white">
            ...
            <div class="col dark:bg-gray-800 dark:text-white">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" class="focus:ring-yellow-500 focus:border-yellow-500 bg-gray-100 dark:bg-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500" disabled value="{{$user->nombre}} {{$user->apellido}}" placeholder="Acxel Fernando Aplicano Aguilar">
                </div>
                <div class="inputBox">
                    <span>Correo:</span>
                    <input type="email" class="focus:ring-yellow-500 focus:border-yellow-500 bg-gray-100 dark:bg-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500" disabled value="{{$user->correo}}" placeholder="example@example.com">
                </div>
            </div>
